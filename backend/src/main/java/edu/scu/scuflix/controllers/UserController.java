...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<String> login(@RequestBody UserDTO userDTO, HttpSession httpSession)
    ...
    @PostMapping("/join")
    ResponseEntity<String> join(@RequestBody UserDTO userDTO, HttpSession httpSession)
            throws UserDetailsNotFoundException {
