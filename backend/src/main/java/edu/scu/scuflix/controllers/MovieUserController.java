...
import edu.scu.scuflix.services.impl.MovieUserServiceImpl;
...
public class MovieUserController {
    ...
    public ResponseEntity<String> searchMoviesByQueryString(
    ...
    public ResponseEntity<String> searchSimilarMoviesById(@RequestParam(value = "page", defaultValue = "1") String page,
            @RequestParam(value = "id", required = true) String id) {
