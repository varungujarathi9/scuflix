...
public class UserServiceImpl implements UserService {
    ...
    public boolean checkUserByPassWord(String password) throws UserDetailsNotFoundException {
        boolean flag = userDao.existsByPassWord(password)
    ...
    public String checkLogin(String email, String passWord, HttpSession httpSession)
            throws UserDetailsNotFoundException {
